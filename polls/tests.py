...
def create_question(question_text, days):
	"""
		Create a question with the give 'question_text' and publish the given 
...
class QuestionDetailViewTests(TestCase):
	...
	def test_past_question(self):
		# The detail view of a question with a a pub_date in the past displays the question's text.
